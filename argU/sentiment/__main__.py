...
def google_topics():
    ...
    google_run(
        topics,
        os.path.join(ROOT_PATH, "argU/sentiment/topic_sentiments.csv"),
        os.path.join(ROOT_PATH, "argU/sentiment/topic_log"),
        "topics",
    )
...
def google_titles():
    google_run(
        read_csv(TITLES_PATH, 100),
        os.path.join(ROOT_PATH, "argU/sentiment/title_sentiments.csv"),
        os.path.join(ROOT_PATH, "argU/sentiment/title_log"),
        "titles",
    )
